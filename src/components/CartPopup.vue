<template>
    <div class="fixed w-full h-full top-0 left-0 flex justify-end items-center z-20">
        ...
        flex flex-col font-monserrat pt-8 justify-between">
            ...
            <div class="flex flex-col w-full flex-grow">
                <div v-for="item in cartItems" class="flex w-full px-5 mt-8 bg-white gap-x-[10px]">
...
const goToOrder = () => {
    const cartData = JSON.stringify(props.cartItems.value);
